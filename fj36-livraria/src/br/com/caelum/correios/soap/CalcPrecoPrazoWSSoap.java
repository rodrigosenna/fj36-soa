...
public interface CalcPrecoPrazoWSSoap {
    ...
    @RequestWrapper(localName = "ListaServicosSTAR", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.soap.ListaServicosSTAR")
    @ResponseWrapper(localName = "ListaServicosSTARResponse", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.soap.ListaServicosSTARResponse")
